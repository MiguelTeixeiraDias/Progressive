...
const styles = StyleSheet.create({
  ...
  scoreValue: { fontFamily: family.display, fontSize: 56, letterSpacing: 0.5, includeFontPadding: false },
  ...
  estValue: { color: colors.primary, fontFamily: family.display, fontSize: font.h2, letterSpacing: 0.5, includeFontPadding: false },
